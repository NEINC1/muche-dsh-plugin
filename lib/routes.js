...
import { requestDshBridgeRefresh, getDshBridgeStatus } from './dsh-bridge.js'
...
export function registerRoutes(ctx, guard) {
  ...
  reg({
    ...
    handler: async (req, res) => {
      ...
      sendJson(res, 200, { ok: true, status: getDshBridgeStatus() })
    },
  })
